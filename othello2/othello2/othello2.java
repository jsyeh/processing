...
public class othello2 extends PApplet {

int [][]grid = new int[10][10];
int []count=new int[3];
int c1=color(255,0,0), c2=color(0,255,0);
int nowColor=1;
public void setup(){
  size(600,400);
  for(int i=0;i<10;i++){
...
public int check8way(int x, int y){
  int sum=0;
  sum+=check1(x,y);
  sum+=check2(x,y);
  sum+=check3(x,y);
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "othello2" });
  }
}
